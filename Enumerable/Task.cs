...
namespace EnumerableTask
{
    ...
    public class Task
    {
        ...
        public IEnumerable<string> GetUppercaseStrings(IEnumerable<string> data)
        {
            ...
            return data.Select(t => t != null ? t.ToUpper() : t);
        }
        ...
        {
            return data.Select(t => t != null ? t.Length : 0);
        }
        ...
        public IEnumerable<T> GetEvenItems<T>(IEnumerable<T> data)
        {
            ...
            return data.Where((t, index) => index % 2 != 0);
        }
        ...
        public IEnumerable<T> PropagateItemsByPositionIndex<T>(IEnumerable<T> data)
        {
            ...
            return data.SelectMany((t, index) => Enumerable.Repeat(t, index + 1));
        }
        ...
        public string GetStringOfSequence<T>(IEnumerable<T> data)
        {
            ...
            return string.Join(",", data.Select((t) => t != null ? t.ToString() : "null"));
        }
        ...
        public IEnumerable<int> Get3TopItems(IEnumerable<int> data)
        {
            ...
            return data.OrderByDescending(t => t).Take(3);
        }
        ...
        public int GetCountOfGreaterThen10(IEnumerable<int> data)
        {
            ...
            return data.Where(t => t > 10).Count();
        }
        ...
        public string GetFirstContainsFirst(IEnumerable<string> data)
        {
            ...
            return data.FirstOrDefault(t => t != null && t.ToLower().Contains("first"));
        }
        ...
        public int GetCountOfStringsWithLengthEqualsTo3(IEnumerable<string> data)
        {
            ...
            return data.Where(t => (t == null ? string.Empty : t).Length == 3).Distinct().Count();
        }
        ...
        public int GetSpecificEventEntriesCount(EventLogEntryType value)
        {
            ...
            return systemEvents.Cast<EventLogEntry>().Where(t => t.EntryType == value).Count();
        ...
        public IEnumerable<string> GetIEnumerableTypesNames(Assembly assembly)
        {
            ...
            return assembly.GetTypes().Where(t => t.IsGenericType && t.GetInterfaces().Contains(typeof(IEnumerable))).Select(t => t.ToString());
        }
        ...
        public int[] GetQuarterSales(IEnumerable<Tuple<DateTime, int>> sales)
        {
            ...
            {
                result[i] = sales.Where(t => t.Item1.Month > i * 3 && t.Item1.Month <= (i + 1) * 3).Sum(t => t.Item2);
            }
        ...
        {
            return data.OrderBy(t => t.Length).ThenBy(t => t);
        }
        ...
        public IEnumerable<char> GetMissingDigits(IEnumerable<string> data)
        {
            ...
            return "0123456789".Except(data.DefaultIfEmpty(string.Empty).Aggregate((result, t) => result + t));
        }
        ...
        public IEnumerable<string> SortDigitNamesByNumericOrder(IEnumerable<string> data)
        {
            ...
            return data.OrderBy(t => Array.IndexOf(array, t));
        }
        ...
        public IEnumerable<string> CombineNumbersAndFruits(IEnumerable<string> numbers, IEnumerable<string> fruits)
        {
            ...
            return numbers.Zip(fruits, (item, item2) => $"{item} {item2}");
        }
        ...
        public IEnumerable<char> GetCommonChars(IEnumerable<string> data)
        {
            ...
            return data.DefaultIfEmpty(string.Empty).Aggregate<IEnumerable<char>>((res, t) => res.Intersect(t));
        }
        ...
        public int GetSumOfAllInts(object[] data)
        {
            ...
            return data.OfType<int>().Sum(t => t);
        }
        ...
        public bool IsAllStringsAreUppercase(IEnumerable<string> data)
        {
            ...
            return data.DefaultIfEmpty(string.Empty).All(t => (t != string.Empty) && t.Equals(t.ToUpper()));
        }
        ...
        public IEnumerable<int> GetFirstNegativeSubsequence(IEnumerable<int> data)
        {
            ...
            return data.SkipWhile(t => t > -1).TakeWhile(t => t < 0);
        }
        ...
        public IEnumerable<string> GetAllPairs(IEnumerable<string> boys, IEnumerable<string> girls)
        {
            ...
            return boys.SelectMany(i1 => girls.Select(i2 => $"{i1} {i2}"));
        }
        ...
        public double GetAverageOfDoubleValues(IEnumerable<object> data)
        {
            ...
            IEnumerable<double> d = data.DefaultIfEmpty(string.Empty).OfType<double>();
            return d.Count() != 0 ? d.Average() : 0.00;
        }
    }
}
